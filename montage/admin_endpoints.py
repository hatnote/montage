...
def import_entries(user_dao, round_id, request_dict):
    ...
    if import_method == 'csv' or import_method == 'gistcsv':
        ...
        if not cat_name:
            ...
            import_warnings.append('Category is required')
        else:
            ...
            try:
                ...
                if not entries:
                    import_warnings.append('No images found in this category')

            except Exception as e:
                print("Import error:", e)
                entries = []
                import_warnings.append('Invalid category or unable to fetch images')
        ...
        if warnings:
            ...
            import_warnings.append({'message': msg})
    ...
    if len(new_entry_stats['disqualified']) >= len(entries):
       new_entry_stats['warnings'].append({
    'message': 'All entries were disqualified by round settings'
})
