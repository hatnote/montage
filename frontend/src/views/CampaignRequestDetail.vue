    ...
    <template v-else-if="req">
      ...
      <div v-if="isMaintainer" class="action-section">
        ...
        <div v-if="activeAction === 'approve'" class="action-panel" role="tabpanel">
          ...
          >
            ...
            <p style="margin: 4px 0 0; font-size: 13px">
              {{ $t('campaign-request-low-volume-advice') }}
            </p>
          </cdx-message>
        ...
        <div v-if="activeAction === 'advise'" class="action-panel" role="tabpanel">
          ...
          <cdx-message v-if="actionError" type="error" inline style="margin-top: 8px">{{
            actionError
          }}</cdx-message>
        </div>
      </div>
...
const NOTE_TEMPLATES = [
  {
    key: 'campaign-request-template-low-volume',
    labelKey: 'campaign-request-template-low-volume-label'
  },
  {
    key: 'campaign-request-template-check-dates',
    labelKey: 'campaign-request-template-check-dates-label'
  },
  {
    key: 'campaign-request-template-missing-info',
    labelKey: 'campaign-request-template-missing-info-label'
  }
]
